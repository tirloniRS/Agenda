package apps.tirloni.com.agenda.adapter;
...
/**
 * Created by Tirloni on 16/02/2017.
 */
...
public class AlunosAdapter extends BaseAdapter {
    ...
    // informa quantos items nosso adapter tem
    @Override
    public int getCount() {
        //devolve quantos items
        return alunos.size();
    }
    ...
    //pega as views e vai construindo
